...
namespace MirokuLearning.EF
{
    public class MirokuLearningContext : DbContext
    {
        ...
        {
            Database.SetInitializer(new MigrateDatabaseToLatestVersion<MirokuLearningContext, MirokuLearning.EF.Migrations.Configuration>("MirokuLearningContext"));
        }
